...
const conquer = fs.existsSync(conquerFileName) ? JSON.parse(fs.readFileSync(conquerFileName, 'utf8')) : {deactivatedRegions: undefined, regions: {}, features: {}, version: ''};
...
module.exports.getConquerStatus = function() {
  return {version: conquer.version, features: conquer.features, warVersion: war.version, requiredVictoryTowns: warapi.warData.requiredVictoryTowns, full: true}
}
