...
class WarApi extends EventEmitter {
  ...
  iconTypes = /** @type{const} */ ({
    ...
    88: {
      type: "industry",
      icon: "MapiIconAircraftDepot",
      notes: "Aircraft Depot",
    },
    89: {
      type: "industry",
      icon: "MapiIconAircraftFactory",
      notes: "Aircraft Factory",
    },
    90: {
      type: "industry",
      icon: "UnderMaintenanceMapIcon", // Missing Icon?
      notes: "Aircraft Radar",
    },
    91: {
      type: "industry",
      icon: "MapiIconAircraftRunwayT1",
      notes: "Aircraft Runway (T1)",
    },
    92: {
      type: "industry",
      icon: "MapiIconAircraftRunwayT2",
      notes: "Aircraft Runway (T2)",
    },
