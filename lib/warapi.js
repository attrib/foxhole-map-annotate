...
class WarApi {
  ...
  async loadWarData() {
    this.warData = fs.existsSync('../data/wardata.json') ? await import('../data/wardata.json') : {shard: config.config.shard.name, warNumber: 0, winner: 'NONE', status: this.WAR_IN_PROGRESS, conquestEndTime: null, conquestStartTime: null}
